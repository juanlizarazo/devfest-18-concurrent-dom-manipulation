...
const callbacks = {}; // Extra function wrapper around user callbacks to ensure that debugging.ts isn't bundled
...
export { sanitizer, callbacks, upgradeElement, upgrade };
//# sourceMappingURL=unminified.index.safe.mjs.map

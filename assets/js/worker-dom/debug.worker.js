var WorkerThread = (function (exports) {
     ...
     * limitations under the License.
     */
    const toString = attributes => attributes.map((_ref) => {
      let name = _ref.name,
          value = _ref.value;
    ...
    class Element extends Node {
      ...
      querySelector(selector) {
        let matches = this.querySelectorAll(selector);
      ...
      querySelectorAll(selector) {
        ...
        return matcher ? matchChildrenElements(this.ownerDocument.documentElement, matcher).filter(element => this !== element && this.contains(element)) : [];
      }
    ...
    */
    ...
    class Document extends Element {
      constructor() {
        super(9
        /* DOCUMENT_NODE */
        , '#document', HTML_NAMESPACE);
        this.documentElement = this;

        this.createElement = tagName => this.createElementNS(HTML_NAMESPACE, tagName); // TODO: Add tests for case-sensitivity of NODE_NAME_MAPPING.


        this.createElementNS = (namespaceURI, tagName) => new (NODE_NAME_MAPPING[toLower(tagName)] || HTMLElement)(1
        /* ELEMENT_NODE */
    ...
    function consumeInitialDOM(document, strings, hydrateableNode) {
      ...
      strings.forEach(string => store$1(string));
      (hydrateableNode[4
      /* childNodes */
     ...
     * limitations under the License.
     */
    const doc = createDocument(undefined);
    const workerDOM = {
      document: doc,
    ...
    window.workerDocument = documentForTesting;

var WorkerThread = (function (exports) {
  ...
  var reflectProperties = function reflectProperties(properties, defineOn) {
    properties.forEach(function (pair) {
      var _loop = function _loop(property) {
        var p = pair[property];
        var defaultValue = p[0];
        var attributeName = p[1] || toLower(property);
        var keywords = p[2];
        var propertyIsNumber = typeof defaultValue === 'number'; // Boolean attributes only care about presence, not attribute value.
  ...
  function (_Node) {
    ...
    _proto.querySelectorAll = function querySelectorAll(selector) {
      ...
      return matcher ? matchChildrenElements(this.ownerDocument.documentElement, matcher).filter(function (element) {
        return _this2 !== element && _this2.contains(element);
      }) : [];
    };
...
//# sourceMappingURL=worker.safe.js.map
